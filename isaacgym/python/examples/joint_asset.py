...
asset_descriptors = [
    ...
    # AssetDesc("resources/robots/go1/urdf/go1.urdf", False),
    ...
    AssetDesc("urdf/kubot23W/urdf/kubot23W_rw.urdf", False)
    # AssetDesc("urdf/rok3_model/urdf/rok3_model.urdf", False)
]
...
# position the camera
cam_pos = gymapi.Vec3(0.0, 2.0, 10)
...
for i in range(num_envs):
    ...
    pose.p = gymapi.Vec3(0.0, 0.3325, 0.0)
